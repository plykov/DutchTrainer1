...
- **Provenance-aware content workflow** (`content/`, `scripts/content-pipeline.mjs`) — the Spreken exam
  bank and Schrijven zinstaken are migrated from hand-edited TypeScript to structured source documents with
...
a Spreken exam and zinstaken pilot, but all remaining banks need migration before shipping to learners; clear the
